...
import 'image_view_insta.dart';
import 'package:url_launcher/url_launcher.dart';
import 'name_json.dart';
import 'photos_json.dart';
import 'profile_insta.dart';

class UserProfileInsta extends StatefulWidget {
  final Name namedata;
  final List<Photos> photosdata;

  const UserProfileInsta({Key key, this.namedata, this.photosdata})
      : super(key: key);

  @override
  _UserProfileInstaState createState() => _UserProfileInstaState();
}

class _UserProfileInstaState extends State<UserProfileInsta> {
  @override
                    ...
                    return GestureDetector(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => ImageViewInsta(
